...
export default function MessageBubble({ message }: MessageBubbleProps) {
  ...
  return (
    <div className={`flex ${isUser ? "justify-end" : "justify-start"}`}>
      {isUser ? (
        <div className="max-w-[70%] px-4 py-2.5 rounded-[20px] rounded-br-md bg-[var(--accent)] text-white text-sm leading-relaxed border-2 border-[#7adfd7] shadow-[0_3px_0_var(--island-teal-deep)]">
          {message.content}
        </div>
      ) : (
        <div className="max-w-[75%] w-full">
          ...
          <div className="flex items-center gap-2 mb-1 px-1">
            <div className="w-6 h-6 rounded-full bg-[var(--accent)] flex items-center justify-center shadow-[0_2px_0_var(--island-teal-deep)]">
          ...
          {hasError ? (
            ...
            <>
              ...
              {/* Text content */}
              <div className="px-4 py-2.5 rounded-[20px] rounded-bl-md bg-[var(--island-paper-soft)] border-2 border-[#e8dcc8] text-[var(--text-1)] text-sm leading-relaxed shadow-[0_3px_0_var(--island-sand-deep)]">
                {message.content}
                {isStreaming && (
